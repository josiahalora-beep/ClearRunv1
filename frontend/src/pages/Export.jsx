  ...
  return (
    <Layout>
      <section className="container-page py-12 sm:py-16">
        ...
        <div className="mt-8 rounded-xl border border-slate-200 bg-white p-6 shadow-card max-w-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
          ...
          {!exported ? (
            <Button data-testid="export-generate-btn" onClick={() => setExported(true)}>
              <FolderOutput className="h-4 w-4" /> Generate Export
            </Button>
          ) : (
            <span data-testid="export-success-message" className="inline-flex items-center gap-2 text-status-complete text-sm font-medium">
