      ...
      <div className="relative overflow-hidden rounded-xl bg-navy-950 px-5 py-10 text-center sm:px-12 sm:py-12">
        ...
        <div className="relative flex flex-col items-center gap-5">
          <h2 className="mobile-safe-text max-w-2xl font-display text-2xl font-bold leading-tight text-white sm:text-4xl">
            {title || "Want to know if one messy record can be closed?"}
          </h2>
          <p className="max-w-xl text-base leading-relaxed text-slate-300">
            {description || "Send one redacted or sample route record. ClearRun returns what is complete, missing, weak, or needs office review."}
          </p>
          <div className="mt-2 flex w-full flex-col gap-3 sm:w-auto sm:flex-row">
            <Link to="/closeout-check" data-testid="cta-band-primary-btn" className="w-full sm:w-auto">
              <Button size="lg" className="bg-white text-navy-950 hover:bg-slate-100 w-full sm:w-auto">
                Get Free Route Closeout Check <ArrowRight className="h-4 w-4" />
              </Button>
            </Link>
            <Link to="/closeout-check#example-check" data-testid="cta-band-secondary-btn" className="w-full sm:w-auto">
